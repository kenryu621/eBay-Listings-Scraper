...
import my_libs.ebay_listings.ebay_listings_data_extraction as ebay_listings
...
def run_ebay_listings_scraper():
    """Run the eBay listings scraper."""
    ...
    ebay_listings.process_keywords(keywords, OUTPUT_FOLDER)
    messagebox.showinfo(
        "eBay Listings Scraper",
        "eBay listings scraper execution completed."
    )


def main():
    setup_logging()
    run_ebay_listings_scraper()
